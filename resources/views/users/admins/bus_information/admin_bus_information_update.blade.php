    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 toppad">
      <div class="panel panel-info">
        <div class="panel-heading">
          <h3 class="panel-title"> Update bus informations for {{ $businfo->name }} </h3>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-lg-12">
              <table class="table table-user-information">
                <form action="{{ url ('admin/updatebusinfo/' . $businfo->id) }}" method="post" >
                  <input type="hidden" name="_token" value="{{csrf_token()}}" />
                    <div class="form-group">
                          <div class="form-group">
                            ...
                            <div class="col-lg-8">
                              <select name="brouter" class="form-control" id="brouter" required>
                                <option value="{{ $businfo->bus_router_id }}">{{ $businfo->bus_router_id }}</option>
                                @foreach ($bus as $id)
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8">
                              <input class="form-control" type="text" value=""  name="drive">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-3 control-label">Ticket Control</label>
                            <div class="col-lg-8">
                              <input class="form-control" type="text" value=""  name="tcontrol">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-3 control-label">Accompanied Service</label>
                            <div class="col-lg-8">
                              <input class="form-control" type="text" value=""  name="aservice">
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-lg-8">
                              <select name="status" class="form-control" id="status" required>
                                <option value="{{ $businfo->status }}">{{ $businfo->status }}</option>
                                <option></option>
                                <option>Ready</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8">
                              <input class="form-control" value="{{ $businfo->number_seats }}" type="number" name="nseats" max="32"  required>
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-lg-8">
                              <select name="user_id" class="form-control" id="uid" required>
                                <option value="{{ $businfo->user_id }}">{{ $businfo->user_id }}</option>
                                @foreach ($user as $id)
                                    <option value="{{ $id->id }}">{{ $id->id }}</option>
                                @endforeach
                                </select>
