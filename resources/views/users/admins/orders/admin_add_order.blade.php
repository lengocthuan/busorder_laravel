                  ...
                  <input type="hidden" name="_token" value="{{csrf_token()}}" />
                    <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8">
                              <input class="form-control" type="number" value="" required="" name="total" min="10000" placeholder="VNĐ" />
                            </div>
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-lg-8">
                              <input class="form-control" type="number" value="" required="" name="booked" min="1" placeholder="input number of tickets booked" />
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-3 control-label">Status</label>
                            <div class="col-lg-8">
                              <input class="form-control" value="" type="text" name="status" required="" placeholder="input status for this invoice">
                            </div>
                          </div>
                    </div>
          </div>
